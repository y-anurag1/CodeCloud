                ...
                >
                    ...
                    <div className="flex flex-col h-[calc(100%-16px)] min-w-[calc(20%-8px)] mr-[8px] flex-grow">
                        <div className="min-h-0 flex-grow min-w-full mr-[8px] mb-[8px] rounded-lg overflow-hidden bg-black border border-borders">
                            <div className="h-[50px] bg-black relative border-b border-borders flex justify-between items-center px-3">
                                <div className="inline-block relative w-fit h-fit rounded-md text-text_2 hover:text-white cursor-pointer text-[14px] transition select-none">
                                    {currentLang}
                                </div>
                                
                                <button
                                    onClick={() => setShowTimer(!showTimer)}
                                    className="px-3 py-1 rounded bg-borders hover:bg-[#404040] text-black text-sm transition-colors"
                                >
