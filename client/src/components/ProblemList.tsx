    ...
    return (
        <div>
            <div className="flex flex-col">
                <div className="flex flex-row w-full text-[14px] h-[40px] items-center text-gray-700 border-b border-borders select-none">
                    <div
                        id="status-label"
                ...
                statusRef.current != null ? (
                    <>
                        ...
                        {data.map(({ main }) => (
                            <div className="border-b border-borders hover:bg-gray-50 transition-colors">
                                <Link
                                    to={`/problem/${main.name}`}
                                    className="problem-list-link w-full h-[40px] flex flex-row whitespace-nowrap"
                                >
                                    <div
                                        style={{
                                            width: statusWidth,
                                    ...
                                    <div className="problem-title flex-grow px-[20px] leading-[40px]">
                                        {main.id}. {kebabToSpacedPascal(main.name)}
                                    </div>
                                    <div
                                        style={{
