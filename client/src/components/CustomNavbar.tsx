...
const CustomNavbar = ({ data }: { data: Navbar }) => {
    const default_color_all: string = "#4a5568";
    const default_color_hover_all: string = "#2d3748";
    const default_bg_color_hover_all: string = "#edf2f7";
    const default_bg_color_all: string = "#ffffff";
    const default_active_color_all: string = "#3182ce";
